...
/**
 * Модули, которые осознанно показывают запасную картинку: своей ещё нет.
 * Список нужен, чтобы забытый модуль отличался от того, про который знают —
 * проверка сборки требует, чтобы каждый модуль каталога был либо со своей
 * картинкой, либо здесь.
 */
export const PENDING_ART = new Set(['mod-laser-1', 'mod-railgun-1']);
